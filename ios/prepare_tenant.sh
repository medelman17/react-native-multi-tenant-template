...
if [ "${CONFIGURATION}" == "Debug" ] || [ "${CONFIGURATION}" == "Dev Debug" ]; then
 echo "DEV"
 echo "tenant_config/$tenant/.env.debug" > /tmp/envfile
 ...
 elif [ "${CONFIGURATION}" == "Alpha" ] || [ "${CONFIGURATION}" == "Alpha Debug" ]; then
 echo "Alpha"
 echo "tenant_config/$tenant/.env.alpha" > /tmp/envfile
else
 echo "DEV"
 echo "tenant_config/$tenant/.env.debug" > /tmp/envfile
fi
